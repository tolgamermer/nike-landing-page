        ...
        <div className="flex flex-col items-start">
          ...
          <div className="flex items-center gap-5 mt-8">
            {socialMedia.map((icon, idx) => (
              <div key={idx} className="flex justify-center w-12 h-12 items-center bg-white rounded-full">
              ...
              <div key={section}>
                ...
                <ul>
                  {section.links.map((link) => (
                    <li key={link} className="mt-3 text-white-400 leading-normal font-montserrat text-base cursor-pointer hover:text-slate-gray">
                      <a>{link.name}</a>
                    </li>
                  ))}
                </ul>
